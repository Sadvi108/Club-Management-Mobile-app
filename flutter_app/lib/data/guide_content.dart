...
/// User guide content.
///
/// Ported verbatim from the Expo app's guide, which was written against the live app and
/// re-checked screen by screen. The Expo guide pairs each page with a bundled screenshot;
/// those are screenshots of the Expo UI, so they are deliberately NOT carried over — a
/// picture of a different app is worse than no picture. Add Flutter captures here when
/// there are real ones to add.
///
