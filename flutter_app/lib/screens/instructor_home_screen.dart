...
const List<_Tile> _tiles = [
  ...
  (id: 'tournament-schedule', label: 'Tournament Schedule', icon: Ion.trophyOutline, color: Color(0xFFEF4444)),
...
const Map<String, String> _tileRoutes = {
  ...
  'tournament-schedule': '/instructor/reports/tournament-upcoming',
