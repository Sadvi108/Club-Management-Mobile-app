...
const List<_Report> kInstructorReports = [
  ...
  (id: 'tournaments-past', label: 'Tournaments (Past)', icon: Ion.trophyOutline, route: '/instructor/reports/tournament-past'),
  (id: 'upcoming-tournaments', label: 'Upcoming Tournaments', icon: Ion.medalOutline, route: '/instructor/reports/tournament-upcoming'),
