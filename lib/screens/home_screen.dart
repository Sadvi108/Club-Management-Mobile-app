            ...
            Container(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      CircleAvatar(radius: 26, backgroundImage: CachedNetworkImageProvider(livePhoto)),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(liveName, style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w800)),
                            ...
                            Container(
                              ...
                              child: Row(mainAxisSize: MainAxisSize.min, children: [
                                ...
                                Text(liveMembership, style: const TextStyle(color: Color(0xFFFFF7ED), fontSize: 10, fontWeight: FontWeight.w700)),
                              ]),
                            ),
                          ],
                        ),
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      Container(width: 1, color: Colors.white.withOpacity(0.25)),
                      _statCell('${session.unreadNotifications}', 'Unread'),
                    ]),
                  ),
                ],
              ),
            ...
            Padding(
              ...
              child: Wrap(
                ...
                children: kQuickCards.map((q) {
                  ...
                  final cols = w < 420 ? 2 : 4;
                  final size = (w - Gaps.lg * 2 - (12 * (cols - 1))) / cols;
                  return SizedBox(
                    width: size,
                    child: InkWell(
