...
class InstructorReportsScreen extends StatelessWidget {
  ...
  static const _items = <_ReportItem>[
    ...
    _ReportItem(Icons.assignment,           'Exam Centers',        '/instructor/reports/exam-centers'),
    _ReportItem(Icons.people_alt,           'Student List',        '/instructor/reports/student-list'),
    _ReportItem(Icons.alarm,                'Training Time',       '/instructor/reports/training-time'),
    _ReportItem(Icons.school,               'Grading Schedule',    '/instructor/reports/grading-schedule'),
    _ReportItem(Icons.history_edu,          'Grading Past',        '/instructor/reports/grading-past'),
    _ReportItem(Icons.warning_amber,        'Outstanding Report',  '/instructor/reports/outstanding'),
    _ReportItem(Icons.receipt_long_outlined,'Missing Invoice',     '/instructor/reports/missing-invoice'),
    _ReportItem(Icons.fact_check,           'Attendance Report',   '/instructor/reports/attendance'),
    _ReportItem(Icons.receipt_long,         'Receipt',             '/instructor/reports/receipt'),
    _ReportItem(Icons.receipt,              'Payment Slip',        '/instructor/reports/payment-slip'),
    _ReportItem(Icons.savings,              'Fee Master',          '/instructor/reports/fee-master'),
    _ReportItem(Icons.person_add_alt,       'New Student',         '/instructor/reports/new-student'),
    _ReportItem(Icons.emoji_events,         'Tournament',          '/instructor/reports/tournament'),
