        ...
        <View style={styles.frame}>
          ...
          {!scanned && (
            <Animated.View style={[styles.laser, { transform: [{ translateY }] }]}>
              <LinearGradient colors={["rgba(79,70,229,0)", "#4F46E5", "rgba(79,70,229,0)"]} style={{ width: "100%", height: 3 }} />
            </Animated.View>
          )}
...
const styles = StyleSheet.create({
  ...
  instruction: { color: "rgba(255,255,255,0.85)", fontSize: 14, marginBottom: 28, fontWeight: "500" },
  ...
  hint: { color: "rgba(255,255,255,0.55)", fontSize: 12, marginTop: 26, textAlign: "center" },
  ...
  footerTxt: { color: "rgba(255,255,255,0.55)", fontSize: 11, fontWeight: "500" },
});
