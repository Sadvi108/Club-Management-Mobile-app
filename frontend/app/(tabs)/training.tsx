      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl, paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
        <LinearGradient colors={colors.gradient} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={[styles.heroCard, shadow.strong]}>
          ...
          <View style={styles.heroStatsRow}>
            <View style={styles.heroStat}><Text style={styles.heroStatNum}>24</Text><Text style={styles.heroStatLbl}>Classes</Text></View>
            <View style={styles.heroStat}><Text style={styles.heroStatNum}>18h</Text><Text style={styles.heroStatLbl}>Trained</Text></View>
            <View style={styles.heroStat}><Text style={styles.heroStatNum}>3</Text><Text style={styles.heroStatLbl}>Sports</Text></View>
          </View>
        </LinearGradient>
          ...
          <View key={p.id} style={styles.programCard} testID={`program-${p.id}`}>
            ...
            <View style={styles.programBody}>
              <View style={styles.programTop}>
                ...
                <View style={[styles.levelPill, { backgroundColor: p.color + (mode === "dark" ? "33" : "18") }]}>
              ...
              <View style={styles.progBg}><View style={[styles.progFill, { width: `${p.progress}%`, backgroundColor: p.color }]} /></View>
              <View style={styles.actionRow}>
                <TouchableOpacity style={[styles.actionBtn, { backgroundColor: colors.primary }]} testID={`program-${p.id}-upgrade`}>
...
function createStyles(colors: any, shadow: any, mode: "light" | "dark") {
  return StyleSheet.create({
    ...
    addProgramBtn: { flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "center", paddingVertical: 16, borderRadius: radius.md, borderWidth: 1, borderStyle: "dashed", borderColor: colors.primary, backgroundColor: colors.surfaceAlt },
