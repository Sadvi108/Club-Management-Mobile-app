...
const SECTIONS: { title: string; items: Option[] }[] = [
  ...
  },
  {
    title: "Club",
    items: [
      { id: "events", label: "Events", icon: "calendar", color: "#F97316", route: "/events" },
      { id: "competition", label: "Competition", icon: "medal", color: "#DB2777", route: "/competition" },
      { id: "offers", label: "Offers", icon: "pricetags", color: "#10B981", route: "/events?tab=offers" },
